...
namespace lib_repositorios
{
    public class Conexion : DbContext
    {
        ...
        protected DbSet<Compuestos>? Compuestos { get; set; }
        protected DbSet<Compuestos_Productos>? Compuestos_Productos { get; set; }
        protected DbSet<Inventarios>? Inventarios { get; set; }
        protected DbSet<Proveedores>? Proveedores { get; set; }
        protected DbSet<Proveedores_Productos>? Proveedores_Productos { get; set; }
        protected DbSet<Ordenes>? Ordenes { get; set; }
        protected DbSet<Tipos_productos>? Tipos_productos { get; set; }
